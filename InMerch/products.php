...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to InMerch!</h1>
                    <p>We have the best informatics merchandise, with the best material for you. </p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/T-shirt.jpg" alt="Cannon">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>T-shirt</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/longsleeve.png" alt="Sony DSLR">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>LongSleeve</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/coachjacket.png" alt="Sony DSLR">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Coach Jacket</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/buckethat.png" alt="Olympus">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Bucket Hat</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/cap.png" alt="Titan 301">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Cap</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/keychain.png" alt="Titan 201">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>KeyChain</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/lighter.png" alt="htm milan">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Lighter</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/totebag.png" alt="Favre Leuba">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Tote Bag</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/stikerpack.png" alt="Raymond shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Sticker Packs</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/bracelet.png" alt="Charles shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Braceleet</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/handfan.png" alt="HXR">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>HandFan</h3>
